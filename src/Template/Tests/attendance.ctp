            ...
            <table class="table01 table03">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- 担当者入力 -->
                        <?php if($users[$i][$j]["staffcheck"]==1 && $users[$i][$j]["status"]!=0): ?>
                            <td style = "background-color: rgb(245, 116, 116);">
                                <?= $this->Html->link(
                                    $tantoutext[$users[$i][$j]["staffcheck"]],
                                    ['action' =>'register',"?"=>["id"=>$users[$i][$j]["userid"],"type"=>0]],
                                    ['class' => 'bla'],
                                ); ?>
                            </td>
                        <?php elseif($users[$i][$j]["staffcheck"]==2): ?>
                            <td>
                                <?= $this->Html->link(
                                    $tantoutext[$users[$i][$j]["staffcheck"]],
                                    ['controller' => 'TimeCards', 'action' =>'getquery1', $users[$i][$j]["userid"]],
                                    ['class' => 'bla'],
                                ); ?>
                            </td>
                        <?php else: ?>
