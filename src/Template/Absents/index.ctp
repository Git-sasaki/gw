...
<div class="main">
    <h3 class="attendance-header">欠席情報編集</h3>
    <?= $this -> Form -> create(__("View"),["type" => "post","url" => ["action" => "new"]]); ?>    
    <fieldset>
        <legend><?= __('新規登録・編集') ?></legend>
    ...
    <fieldset class = "mt10">    
        ...
        <div class = "odakoku ml10">
            ...
            <div class = "staffbox2">
                <?php echo $this->Form->label("欠席者")?>
                <?php echo $this->Form->select('user_id',$users,array('id'=>'user','label' => "欠席者",'type'=> 'select','empty'=>array('0'=>'ALL')));?>
            </div>
        </div>
            <div class="ml10_button">
                <?= $this->Form->button(__("送信")) ?>
