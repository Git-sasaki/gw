...
<div class = "main">
<h3 class="attendance-header">出勤簿編集</h3>
    <?= $this -> Form -> create(__("View"),["type" => "post","url" => ["action" => "edit2"]],array('target' => '_blank')); ?>
        <fieldset>
            ...
            <?php if($this->request-> getSession()->read('Auth.User.adminfrag') == 1): ?>
                ...
                <div class = "staffbox ml10 mt10">
                    <?= $this->Form->select('id',$staffs,array('id'=>'staff_id','label' => false,'empty'=>false));?>
                </div>
            <?php endif; ?>
